...
Comprehensive SEO analysis skill for Codex. 21 core sub-skills covering technical SEO, on-page analysis, content quality (E-E-A-T), schema markup, image optimization, sitemap architecture, AI search optimization (GEO), local SEO, maps intelligence, semantic topic clustering, search experience optimization (SXO), SEO drift monitoring, e-commerce SEO, international SEO with cultural profiles, FLOW framework integration, Google SEO APIs (Search Console, PageSpeed, CrUX, GA4), PDF report generation, and strategic planning.

![SEO Command Demo](screenshots/seo-command-demo.gif)

[![CI](https://github.com/AgriciDaniel/Codex-seo/actions/workflows/ci.yml/badge.svg)](https://github.com/AgriciDaniel/Codex-seo/actions/workflows/ci.yml)
[![Codex Skill](https://img.shields.io/badge/Codex%20Code-Skill-blue)](https://Codex.ai/Codex)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Version](https://img.shields.io/github/v/release/AgriciDaniel/Codex-seo)](https://github.com/AgriciDaniel/Codex-seo/releases)

> Using Codex instead of Codex? Use [Codex SEO](https://github.com/AgriciDaniel/codex-seo), the Codex-first port of this project with Codex skills, TOML agents, plugin packaging, deterministic runners, and the same SEO workflow surface.
...
### Plugin Install (Codex 1.0.33+)

```bash
# Add marketplace (one-time)
/plugin marketplace add AgriciDaniel/Codex-seo

# Install plugin
/plugin install Codex-seo@AgriciDaniel-Codex-seo
```
...
```bash
curl -fsSL install.cat/AgriciDaniel/Codex-seo | bash
```

Prefer to review the script before running?

```bash
curl -fsSL https://raw.githubusercontent.com/AgriciDaniel/Codex-seo/main/install.sh > install.sh
...
> **Why git clone instead of `irm | iex`?** Codex's own security guardrails flag `irm ... | iex` as a supply chain risk (downloading and executing remote code with no verification). The git clone approach lets you inspect the script at `Codex-seo\install.ps1` before running it.
...
~/.Codex/skills/seo-*/       # Sub-skills (21 + 3 extensions)
~/.Codex/agents/seo-*.md     # Subagents (15 + 2 extensions)
```
...
[Codex Banana](https://github.com/AgriciDaniel/banana-Codex) Creative Director pipeline.
...
Already using standalone Codex Banana? The extension reuses your existing nanobanana-mcp setup.
...
Community projects built on top of Codex SEO:

<table>
<tr>
<td width="40%">
  <a href="https://github.com/avalonreset/Codex-seo-dungeon">
    <img src="https://raw.githubusercontent.com/avalonreset/Codex-seo-dungeon/main/screenshots/battle-scene.webp" alt="Codex SEO Dungeon - turn-based SEO battle scene with Guild Ledger">
  </a>
</td>
<td width="60%">

**[Codex SEO Dungeon](https://github.com/avalonreset/Codex-seo-dungeon)** -- a 16-bit gamified dungeon crawler that turns SEO audits into boss battles. Built on Codex SEO v1.9.0 with Phaser 3, every detected issue becomes a demon and every fix becomes a real commit to your codebase. The Guild Ledger streams Codex's tool calls in real time as you fight.
...
Want your project featured here? [Open an issue](https://github.com/AgriciDaniel/Codex-seo/issues/new) with a link.

## Ecosystem

Codex SEO is part of a family of Codex skills that work together:

| Skill | What it does | How it connects |
|-------|-------------|-----------------|
| [Codex SEO](https://github.com/AgriciDaniel/Codex-seo) | SEO analysis, audits, schema, GEO | Core -- analyzes sites, generates action plans |
| [Codex Blog](https://github.com/AgriciDaniel/Codex-blog) | Blog writing, optimization, scoring | Companion -- write content optimized by SEO findings |
| [Codex Banana](https://github.com/AgriciDaniel/banana-Codex) | AI image generation via Gemini | Shared -- generates images for SEO assets and blog posts |
...
| [AI Marketing Codex](https://github.com/zubair-trabzada/ai-marketing-Codex) | Copywriting, emails, social, ads, funnels, CRO | Community -- post-audit marketing action from SEO findings |
...
Built for Codex by [@AgriciDaniel](https://github.com/AgriciDaniel)
